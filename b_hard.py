...
def create_game_grid():
    """Create the 8x8 game grid with images"""
    ...
    # Create image categories - 16 of each type
...
def run_competitive_round():
    ...
    el_tracker.sendMessage(f"ROUND_{current_round}_START_TARGET_{target_position}_CATEGORY_{target_category}")
...
# Show instructions
task_msg = 'Computer B - Competitive Memory Game\n\n'
task_msg += 'Two-Player Competitive Rules:\n'
task_msg += '• 8x8 grid with 64 images (16 each: Face, Limb, House, Car)\n'
...
try:
    ...
    if recording_success:
        ...
        completion_msg = f'Computer B - Game Complete!\n\n'
