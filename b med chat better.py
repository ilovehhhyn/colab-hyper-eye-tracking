...
GAZE_PORT = 8889
SEND_PORT = 8888
GAME_PORT = 8891  # Port for game synchronization
...
print("=" * 60)
print("COMPUTER B - COMPETITIVE MEMORY GAME")
print("=" * 60)
...
# Gaze markers - Different colors for Computer B
